...
@Getter
@Setter
public class AppointmentUpReqDTO {
    ...
    @NotBlank(message = "Hãy nập giá trị cho trạng thái")
    @NotEmpty(message = "Trạng thái không thể để trống")
    @Pattern(regexp = "^[01]$", message = "Trạng thái không hợp lệ")
    private String isAvailable;

    public Appointment toAppointment(Long id, Doctor doctor, Room room, ETime eTime, boolean isAvailable){
